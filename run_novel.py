...
from model_novel import CrossModel
...
class TrainLoop_fusion_gen():
    def __init__(self, opt, is_finetune):
        ...
        self.entityId2entity={self.entity2entityId[key]:key for key in self.entity2entityId if self.entity2entityId[key] is not None}
            ...
            for word in sen:
                if word>3:
                    if word==6: #if MOVIE token
                        ...
                        try:
                            sentence.append('@' + str(self.entity2id[self.entityId2entity[all_movie_labels[curr_movie_token]]]))
                        except:
                            # sentence.append('@_UNK_')
