    ...
    def forward(self, xs, ys, mask_ys, concept_mask, db_mask, seed_sets, labels, con_label, db_label, entity_vector, rec,movies_gth=None, movie_nums=None, test=True, cand_params=None, prev_enc=None, maxlen=None,
        ...
        if self.is_finetune:
            ...
            if test == False:
                ...
                new_encoder_output = grad_mul_const(new_encoder_output, 0.0) # don't backpropagate selection loss to stage 1 decoder
                new_encoder_mask = grad_mul_const(new_encoder_mask, 0.0) # don't backpropagate selection loss to stage 1 decoder
